...
class VersionInfo {
    ...
    static let version = Version(major: 3, minor: 7, patch: 2)
    static let previousVersion = Version(major: 3, minor: 7, patch: 1)
    
    static let updateLogVersion = Version(major: 3, minor: 7, patch: 2)
