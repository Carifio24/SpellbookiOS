...
class VersionInfo {
    ...
    static let version = Version(major: 3, minor: 10, patch: 0)
    static let previousVersion = Version(major: 3, minor: 9, patch: 0)
    
    static let updateLogVersion = Version(major: 3, minor: 10, patch: 0)
