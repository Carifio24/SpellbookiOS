...
class VersionInfo {
    ...
    static let version = Version(major: 3, minor: 7, patch: 0)
    static let previousVersion = Version(major: 3, minor: 6, patch: 3)
    
    static let updateLogVersion = Version(major: 3, minor: 7, patch: 0)
